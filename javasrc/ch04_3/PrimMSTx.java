...
/*
 * Official Prim MST from website, it scans minimum spanning FOREST.
*/
...
public class PrimMSTx {
     ...
     */
    public PrimMSTx(EdgeWeightedGraph G) {
        edgeTo = new Edge[G.V()];
    ...
    public Iterable<Edge> edges() {
        LinkedListQueue<Edge> mst = new LinkedListQueue<Edge>();
