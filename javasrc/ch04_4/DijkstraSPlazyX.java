...
public class DijkstraSPlazyX {
    ...
    public DijkstraSPlazyX(EdgeWeightedDigraph G, int s) {
        ...
        while (!pq.isEmpty()) {
            ...
            int v = e.from(), w = e.to();
            if (!marked[w])
                relax(G, w); // lazy, so w might already have been relaxed
        }
    ...
    public static void main(String[] args) {
        ...
        int s = 0;
        DijkstraSPlazyX spt = new DijkstraSPlazyX(G, s);
        StdOut.println();
