 ...
 * takes &Theta;(<em>V</em> + <em>E</em>) time in the worst case, where
 * <em>V</em> is the number of vertices and <em>E</em> is the number of edges.
 * Each instance method takes &Theta;(1) time. It uses &Theta;(<em>V</em>) extra
 * space (not including the edge-weighted digraph).
 * <p>
...
public class AcyclicLP {
    ...
    public AcyclicLP(EdgeWeightedDigraph G, int s) {
        ...
        TopologicalEWDG topological = new TopologicalEWDG(G);
