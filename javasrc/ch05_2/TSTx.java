...
/*
* TST Symbol Table, official implementation, from website
*  
*/
...
public class TSTx<Value> {
    ...
    private void collect(Node<Value> x, StringBuilder prefix, LinkedListQueue<String> queue) {
        if (x == null) return;
    ...
    public static void main(String[] args) {
        ...
        TSTx<Integer> st = new TSTx<Integer>();
