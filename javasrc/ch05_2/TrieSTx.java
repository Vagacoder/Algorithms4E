...
public class TrieSTx<Value> {
    ...
    public Iterable<String> keysWithPrefix(String prefix) {
        LinkedListQueue<String> results = new LinkedListQueue<String>();
        Node x = get(root, prefix, 0);
        collect(x, new StringBuilder(prefix), results);
        return results;
    }

    private void collect(Node x, StringBuilder prefix, LinkedListQueue<String> results) {
        if (x == null)
            return;
        if (x.val != null)
    ...
    private void collect(Node x, StringBuilder prefix, String pattern, LinkedListQueue<String> results) {
        if (x == null)
            return;
        int d = prefix.length();
    ...
    public static void main(String[] args) {
        ...
        TrieSTx<Integer> st = new TrieSTx<Integer>();
