 ...
 * <p>
 * This implementation uses a <em>red-black BST</em>. The <em>put</em>,
 * <em>get</em>, <em>contains</em>, <em>remove</em>, <em>minimum</em>,
 * <em>maximum</em>, <em>ceiling</em>, and <em>floor</em> operations each take
 * &Theta;(log <em>n</em>) time in the worst case, where <em>n</em> is the
 * number of key-value pairs in the symbol table. The <em>size</em> and
 * <em>is-empty</em> operations take &Theta;(1) time. Construction takes
 * &Theta;(1) time.
 * <p>
