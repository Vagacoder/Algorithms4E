...
public class SETx<Key extends Comparable<Key>> implements Iterable<Key> {
     ...
     * @throws IllegalArgumentException if {@code that} is {@code null}
     */
    public SETx<Key> intersects(SETx<Key> that) {
        if (that == null)
    ...
    public static void main(String[] args) {
        SETx<String> set = new SETx<String>();
        ...
        StdOut.println();
        SETx<String> set2 = new SETx<String>(set);
