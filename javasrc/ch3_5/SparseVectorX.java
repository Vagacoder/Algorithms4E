...
public class SparseVectorX {
     ...
     *                                  equal
     */
    public double dot(SparseVectorX that) {
        if (this.d != that.d)
     ...
     */
    public SparseVectorX scale(double alpha) {
        SparseVectorX c = new SparseVectorX(d);
        for (int i : this.st.keys())
     ...
     *                                  equal
     */
    public SparseVectorX plus(SparseVectorX that) {
        if (this.d != that.d)
            throw new IllegalArgumentException("Vector lengths disagree");
        SparseVectorX c = new SparseVectorX(d);
        for (int i : this.st.keys())
    ...
    public static void main(String[] args) {
        SparseVectorX a = new SparseVectorX(10);
        SparseVectorX b = new SparseVectorX(10);
        a.put(3, 0.50);
        a.put(9, 0.75);
        a.put(6, 0.11);
        a.put(6, 0.00);
