...
// * official red-black tree

/******************************************************************************
 *  Compilation:  javac RedBlackBSTx.java
 *  Execution:    java RedBlackBSTx < input.txt
...
public class RedBlackBSTx<Key extends Comparable<Key>, Value> {
    ...
    ***************************************************************************/
    ...
    /**
     * Unit tests the {@code RedBlackBSTx} data type.
     *
     * @param args the command-line arguments
     */
    public static void main(String[] args) { 
        RedBlackBSTx<String, Integer> st = new RedBlackBSTx<String, Integer>();
