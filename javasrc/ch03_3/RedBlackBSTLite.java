...
// * offical red black tree lite version implementing only put, get, and contains.
...
import lib.*;
 ...
 public class RedBlackBSTLite<Key extends Comparable<Key>, Value> {
    ...
    ***************************************************************************/
    ...
    private void keys(Node x, LinkedListQueue<Key> queue) { 
        if (x == null) return; 
        keys(x.left, queue); 
        queue.enqueue(x.key); 
        keys(x.right, queue); 
    ...
    ***************************************************************************/
    public static void main(String[] args) {
        ...
        RedBlackBSTLite<String, Integer> st = new RedBlackBSTLite<String, Integer>();
        ...
        RedBlackBSTLite<Integer, Integer> st2 = new RedBlackBSTLite<Integer, Integer>();
        for (int i = 0; i < n; i++) {
            st2.put(i, i);
            int h = st2.height();
