...
THIS ONE IS FROM ONLINE, WITH JAVADOC
*/
/******************************************************************************
 ...
 * using <em>selection sort</em>. This implementation makes ~ &frac12;
 * <em>n</em><sup>2</sup> compares to sort any array of length <em>n</em>, so it
 * is not suitable for sorting large arrays. It performs exactly <em>n</em>
 * exchanges.
 * <p>
