...
/*
* Official TwoColor from website
*/
 ...
 * undirected graph is <em>bipartite</em> or whether it has an <em>odd-length
...
public class Bipartite {
    ...
    private LinkedListStack<Integer> cycle; // odd-length cycle
