...
/*
* Official Bread-first Paths from website
*/
 ...
 * @author Kevin Wayne
 */
public class BreadthFirstPathsX {
     ...
     */
    public BreadthFirstPathsX(Graph G, int s) {
     ...
     */
    public BreadthFirstPathsX(Graph G, Iterable<Integer> sources) {
        marked = new boolean[G.V()];
        distTo = new int[G.V()];
        edgeTo = new int[G.V()];
        for (int v = 0; v < G.V(); v++)
