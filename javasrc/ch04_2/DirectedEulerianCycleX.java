...
/*
 * Offical DirectedEulerianCycle from website
*/
...
import javasrc.ch04_1.Graph;
import javasrc.ch04_1.BreadthFirstPaths;
...
public class DirectedEulerianCycleX {
    ...
    private static void unitTest(Digraph G, String description) {
        ...
        DirectedEulerianCycleX euler = new DirectedEulerianCycleX(G);
